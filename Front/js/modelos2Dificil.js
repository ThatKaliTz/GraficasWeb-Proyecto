...
function reiniciar() {
    ...
    window.location.href = "Nivel2Dificil.html"; // Redirige a nivel1.html al reiniciar
}
...
btnContinuar.addEventListener("click", function() {
    window.location.href = "Nivel3Dificil.html"; // Redirige a Nivel3.html al hacer clic en Continuar
});
