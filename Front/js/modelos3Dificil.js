...
function reiniciar() {
    ...
    window.location.href = "Nivel3Dificil.html"; // Redirige a nivel1.html al reiniciar
}
...
document.addEventListener('keydown', (event) => {
    ...
    switch (key) {
		...
		case 'm':
			...
			increaseScore(190); //100 PUNTOS POR NOTA
		...
		case 'e':
			if (interaccionNota1P) {
				...
				increaseScore2(190); // 100 PUNTOS POR NOTA
